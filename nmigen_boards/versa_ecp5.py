...
class _VersaECP5Platform(LatticeECP5Platform):
    ...
    resources   = [
        ...
        *SPIFlashResources(0,
        ...
        Resource("ddr3", 0,
            Subsignal("reset",   PinsN("N4", dir="o"), Attrs(IO_TYPE="SSTL135_I", SLEWRATE="FAST", TERMINATION="OFF")),
            Subsignal("clk",     DiffPairs("M4", "N5", dir="o"), Attrs(IO_TYPE="SSTL135D_I", SLEWRATE="FAST", TERMINATION="OFF")),
            Subsignal("clk_en",  Pins("N2", dir="o"), Attrs(IO_TYPE="SSTL135_I", SLEWRATE="FAST", TERMINATION="OFF")),
            Subsignal("cs",      PinsN("K1", dir="o"), Attrs(IO_TYPE="SSTL135_I", SLEWRATE="FAST", TERMINATION="OFF")),
            Subsignal("we",      PinsN("M1", dir="o"), Attrs(IO_TYPE="SSTL135_I", SLEWRATE="FAST", TERMINATION="OFF")),
            Subsignal("ras",     PinsN("P1", dir="o"), Attrs(IO_TYPE="SSTL135_I", SLEWRATE="FAST", TERMINATION="OFF")),
            Subsignal("cas",     PinsN("L1", dir="o"), Attrs(IO_TYPE="SSTL135_I", SLEWRATE="FAST", TERMINATION="OFF")),
            Subsignal("a",       Pins("P2 C4 E5 F5 B3 F4 B5 E4 C5 E3 D5 B4 C3", dir="o"), Attrs(IO_TYPE="SSTL135_I", SLEWRATE="FAST", TERMINATION="OFF")),
            Subsignal("ba",      Pins("P5 N3 M3", dir="o"), Attrs(IO_TYPE="SSTL135_I", SLEWRATE="FAST", TERMINATION="OFF")),
            Subsignal("dqs",     DiffPairs("K2 H4", "J1 G5", dir="io"), Attrs(IO_TYPE="SSTL135D_I", SLEWRATE="FAST", TERMINATION="OFF", DIFFRESISTOR="100")),
            Subsignal("dq",      Pins("L5 F1 K4 G1 L4 H1 G2 J3 D1 C1 E2 C2 F3 A2 E1 B1",
                                      dir="io")), Attrs(IO_TYPE="SSTL135_I", SLEWRATE="FAST", TERMINATION="75"),
            Subsignal("dm",      Pins("J4 H5", dir="o"), Attrs(IO_TYPE="SSTL135_I", SLEWRATE="FAST", TERMINATION="OFF")),
            Subsignal("odt",     Pins("L2", dir="o"), Attrs(IO_TYPE="SSTL135_I", SLEWRATE="FAST", TERMINATION="OFF")),
        )
    ]
    connectors = [
        Connector("expcon", 1, """
